...
const Page = async ({ params: { lng } }: PageProps) => {
  ...
  return (
    <>
      ...
      <div className=" container mx-auto flex min-h-screen animate-fade-right items-center justify-center px-4">
        <div className="mx-auto mt-32 grid w-full grid-cols-1 gap-8 sm:mt-0 sm:grid-cols-3 xl:gap-16">
          {socials.map((s) => (
            <Card key={s.label}>
              <Link
                href={s.href}
